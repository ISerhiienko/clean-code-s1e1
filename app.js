...
var createNewTaskElement=function(taskString){
  ...
  label.className = "task section__tasks-label";

  //Each elements, needs appending
  checkBox.type = "checkbox";
  checkBox.className = "input__task--checkbox";
  editInput.type = "text";
  editInput.className = "task input__task";

  editButton.innerText = "Edit"; //innerText encodes special characters, HTML does not.
  editButton.className = "edit section__button button";

  deleteButton.className = "button__delete button button-delete";
